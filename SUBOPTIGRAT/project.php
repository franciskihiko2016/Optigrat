...
Success! Well done its submitted.
						   ...
						   ?>
						  <form role="form" method="POST" class="" action="project.php">
					 ...
					 <div class="col-md-8" style="font-family:Verdana, Geneva, sans-serif">
					  ...
					  <hr/>
					    ...
					    <b>PAST JOBS UNDERTAKEN</b></br></br>
                   <b> Optigrat Limited</b> executed :
				   <ul>
				   <li>The job of constructing a class room in <b>Mukuyuni secondary school.</b></li>
					
					<li>Supply and delivery of building and construction materials to various clients. </li>
                    <li>Business training services to various institutions in Makueni and Mombasa County.</li> 
                      </ul>
