...
<body>
    ...
    <li><a href="our team.php">OurTeam</a></li>
...
Success! Well done its submitted.
						   ...
						   ?>
						  <form role="form" method="POST" class="" action="ourteam.php">
					 ...
					 <div class="col-md-8"  style="font-family:Verdana, Geneva, sans-serif">
					  ...
					  <span class="text-center">HUMAN RESOURCES </span>
					  <hr/>
					  </br>
				    <p style="font-size:px;font-weight:10;font-family:Verdana, Geneva, sans-serif;font:bold;">
             OPTIGRAT LIMITED is headed by a youthful managing director with a background in business
              management.  </br>In order to meet increasing client base Optigrat Limited has recruited an engineer 
          who offers technical advice on matters and a pool of consultants from whom services are outsourced.  
</p>
					  </p>
